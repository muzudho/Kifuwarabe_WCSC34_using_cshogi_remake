import os
import datetime
from v_a13_0_lib import Turn, Move, EvalutionMmTable
from v_a13_0_eval_lib import EvaluationLib
...
class EvaluationKkTable():
    ...
    _e_relative_index_to_relative_sq = {
        0: -10,
        1: -9,
        2: -8,
        3: -1,
    ...
    def destructure_k_index(
        ...
        # Ｅブロック
        relative_sq = EvaluationKkTable._e_relative_index_to_relative_sq[relative_index]
