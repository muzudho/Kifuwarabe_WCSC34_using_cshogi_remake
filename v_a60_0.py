...
#              python v_a60_0.py
from                  v_a60_0_eval.edit import EvaluationEdit
...
from                  v_a60_0_misc.choice_best_move import ChoiceBestMove
from                  v_a60_0_misc.game_result_document import GameResultDocument
from                  v_a60_0_misc.learn_game import LearnGame
from                  v_a60_0_misc.lib import Turn, Move, MoveHelper, BoardHelper
engine_version_str = "v_a60_0"
...
""")
        ...
        for tier_th, ranked_strict_move_u_set in enumerate(ranked_strict_move_u_set_list):
            print(f'  ランク付けされた指し手一覧（{tier_th:2}位）：')
            for ranked_move_u in ranked_strict_move_u_set:
                print(f'    turn:{Turn.to_string(self._board.turn)}  {tier_th:2}位  strict F:{ranked_move_u:5}  O:*****')
