...
import datetime
import random
from v_a12_0_lib import Turn, Move, MoveHelper, BoardHelper, MoveListHelper, PolicyHelper, GameResultFile
from v_a12_0_eval_kk import EvaluationKkTable
