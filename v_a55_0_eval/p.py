    ...
    def get_index_by_p_move(
        ...
        # 成る手
            ...
            try:
                ...
                print(f"[evaluation p move > get index by p move > 成る手1] p_move_obj.as_usi:{p_move_obj.as_usi}  P srcloc_u:{Usi.srcloc_to_code(p_srcloc)}  rotated:{is_rotate}  p_src_masu:{Usi.srcloc_to_jsa(p_srcsq)}  成:{p_move_obj.promoted}  ex:{ex}")
