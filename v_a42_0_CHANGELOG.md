* good/bad の判定方法を統一
  * MoveAndPolicyHelper.select_good_f_move_u_set_power(...) を削除
  * MoveAndPolicyHelper.select_good_f_move_u_set_facade(...) を新規作成
  * weaken と strengthen と policy の good/bad 判定部分を共通化
