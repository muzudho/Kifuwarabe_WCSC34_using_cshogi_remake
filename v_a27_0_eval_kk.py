...
class EvaluationKkTable():
    ...
    def get_index_of_kk_table(
        ...
        if is_rotate:
            ...
            l_move_obj = l_move_obj.rotate()

        # 0 ～ 296_479 =                             0 ～ 543 *    544 +                             0 ～ 543
        kk_index       = EvaluationKMove.get_index_by_k_move(
                k_move_obj,
                is_rotate) * EvaluationKMove.get_serial_number_size() + EvaluationKMove.get_index_by_k_move(
                        l_move_obj,
                        is_rotate)
