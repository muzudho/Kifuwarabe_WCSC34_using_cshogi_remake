import os
import datetime
from v_a27_0_lib import Turn, Move, EvalutionMmTable
from v_a27_0_eval_lib import EvaluationLib
from v_a27_0_eval_k import EvaluationKMove
from v_a27_0_eval_p import EvaluationPMove
...
class EvaluationKpTable():
    ...
    def get_index_of_kp_table(
        ...
        # 後手なら、指し手を１８０°回転させます
        if is_rotate:
            k_move_obj = k_move_obj.rotate()
            p_move_obj = p_move_obj.rotate()

        # 0 ～ 2_078_084 =                             0 ～ 543 * 3813 +                            0 ～ 3812
        kp_index         = EvaluationKMove.get_index_by_k_move(
                k_move_obj,
                is_rotate) * EvaluationPMove.get_serial_number_size() + EvaluationPMove.get_index_by_p_move(
                        p_move_obj,
                        is_rotate)
