# python v_a42_0_eval_kk.py
import cshogi
import os
import datetime
from v_a42_0_lib import Turn, Move, EvalutionMmTable
from v_a42_0_eval_lib import EvaluationLib
from v_a42_0_eval_k import EvaluationKMove
...
class EvaluationKkTable():
    ...
    def load_on_usinewgame(
        ...
        turn : int
            手番
        """
        file_name=f'data[{self._engine_version_str}]_n1_eval_kk_{Turn.to_string(turn)}.bin'
